...
/* GDT描述符属性 */
#define	DESC_G_4K    1  // 长度单位为 4KB
#define	DESC_D_32    1  // 指令和数据是 32 位的 
#define DESC_L	     0	// 64位代码标记，此处标记为0便可。
#define DESC_AVL     0	// cpu不用此位，暂置为0  
#define DESC_P	     1  // 段在内存中存在
#define DESC_DPL_0   0  // DPL: 特权级
#define DESC_DPL_1   1
#define DESC_DPL_2   2
#define DESC_DPL_3   3

#define DESC_S_CODE	1       // s 为 1 时表示数据/代码段,为 0 时表示系统段/门描述符
